    ...
    <div className="flex flex-col min-h-full bg-[#FDFCF8] relative md:overflow-hidden">
      <main className="flex-1 relative flex flex-col items-center justify-start p-4 md:p-12 pt-12 md:pt-24">
        ...
        <div className="max-w-2xl w-full animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20 md:pb-0">
          ...
          <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 text-slate-900 relative overflow-hidden shadow-xl border border-slate-100 group">
              ...
              <div className="relative z-10 flex flex-col items-center text-center space-y-6 md:space-y-8">
                  <div className="w-12 h-12 md:w-20 md:h-20 bg-gradient-to-br from-[#B48646] to-[#E5B066] rounded-xl md:rounded-2xl flex items-center justify-center text-white shadow-lg transform group-hover:scale-110 transition-transform duration-500">
                      <Hourglass size={24} strokeWidth={2} className="md:w-10 md:h-10 animate-pulse" />
                  </div>

                  <div className="space-y-2">
                      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#B48646]/10 text-[#B48646] text-[10px] md:text-xs font-bold uppercase tracking-widest">
                          Restez à l'écoute
                      </div>
                  </div>

                  <p className="text-slate-500 text-[11px] md:text-lg font-medium leading-relaxed max-w-xl">
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-3 md:gap-4 w-full md:w-auto pt-2">
                      <a 
                          ...
                          className="w-full md:w-auto bg-blue-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl md:rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20 text-xs md:text-sm active:scale-95"
                      >
                          <Facebook size={16} className="md:w-5 md:h-5" /> Suivre sur Facebook
                      </a>
                      <button 
                          onClick={() => onNavigate && onNavigate(0)}
                          className="w-full md:w-auto bg-slate-100 text-slate-600 px-6 md:px-8 py-3 md:py-4 rounded-xl md:rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-slate-200 transition-all text-xs md:text-sm active:scale-95"
                      >
          ...
          <div className="mt-6 md:mt-8 bg-slate-50/50 backdrop-blur-sm rounded-[1.5rem] md:rounded-[2rem] p-4 md:p-6 border border-slate-100 text-center flex items-center justify-center gap-4 md:gap-6">
              ...
              <div className="text-left">
                  <h3 className="text-[10px] md:text-xs font-bold text-slate-900 uppercase tracking-wider">Créations exclusives Infini 24</h3>
