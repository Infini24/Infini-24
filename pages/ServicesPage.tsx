...
// --- PROJECT WORKFLOW MODAL (Replaces Payment Modal for large projects) ---
...
const ServicesPage: React.FC<ServicesPageProps> = ({ initialService, onClearInitial, user, onLoginReq, initialModalData, onConsumePending, onLoginClick, onLogout }) => {
  ...
  const renderContent = () => {
    ...
    return (
      <div className="max-w-7xl mx-auto w-full px-2">
        ...
        <header className="flex-none pt-14 pb-10 px-6 bg-white border-b border-slate-50 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] relative overflow-hidden rounded-b-[3.5rem] mb-8 z-10">
            {/* Background Blurs */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#B48646] to-[#F3C06B] rounded-full blur-[80px] opacity-15 -mr-16 -mt-16 animate-pulse"></div>
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-slate-900 rounded-full blur-[60px] opacity-5 -ml-10 -mb-10"></div>
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto no-scrollbar pt-0 pb-12 bg-[#FDFCF8]">
